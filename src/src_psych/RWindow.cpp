#include <RWindow.h>
 ...
 Window::Window(Input* input) : height(input->settings.resolution[1]), width(input->settings.resolution[0]), display_mode(input->settings.display_mode) {
 ...
 void Window::enableInfiniteMouse()
 {
     glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
 }
 void Window::disableInfiniteMouse()
 {
