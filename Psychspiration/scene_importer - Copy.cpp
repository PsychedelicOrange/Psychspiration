...
int main()
{
    ...
    Shader simpleDepthShader("C:\\Users\\parth\\source\\repos\\Psychspiration\\resources\\shaders\\simpleDepthShader.vs", "C:\\Users\\parth\\source\\repos\\Psychspiration\\resources\\shaders\\simpleDepthShader.fs", "C:\\Users\\parth\\source\\repos\\Psychspiration\\resources\\shaders\\simpleDepthShader.gs");
    ...
    // point light 4
    ourShader.setVec3("pointLights[3].position", pointpointLightPositions[0]itions[3]);
...
// -----------------------
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       // -----------------------------------------------
        ...
        shadowTransforms.push_back(shadowProj * glm::lookAt(pointLightPositions[0], pointLightPositions[0] + glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3(0.0f, -1.0f, 0.0f)));
        shadowTransforms.push_back(shadowProj * glm::lookAt(pointLightPositions[0], pointLightPositions[0] + glm::vec3(-1.0f, 0.0f, 0.0f), glm::vec3(0.0f, -1.0f, 0.0f)));
        shadowTransforms.push_back(shadowProj * glm::lookAt(pointLightPositions[0], pointLightPositions[0] + glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 0.0f, 1.0f)));
        shadowTransforms.push_back(shadowProj * glm::lookAt(pointLightPositions[0], pointLightPositions[0] + glm::vec3(0.0f, -1.0f, 0.0f), glm::vec3(0.0f, 0.0f, -1.0f)));
        shadowTransforms.push_back(shadowProj * glm::lookAt(pointLightPositions[0], pointLightPositions[0] + glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(0.0f, -1.0f, 0.0f)));
        shadowTransforms.push_back(shadowProj * glm::lookAt(pointLightPositions[0], pointLightPositions[0] + glm::vec3(0.0f, 0.0f, -1.0f), glm::vec3(0.0f, -1.0f, 0.0f)));
        ...
        axes.Draw(ourShader);
        ourShader.use();
        ourShader.setInt("depthCubemap", 4);
