...
inline gli::texture::storage_type::size_type gli::texture::getBaseOffset(size_type Layer, size_type Face, size_type Level)
{
	return this->Storage->base_offset(Layer, Face, Level);
}